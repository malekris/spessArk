...
export const DEFAULT_TIMETABLE_CONFIG = {
  ...
  clusterWindows: {
    ...
    upper: [
      { day: "Monday", slotCodes: ["P1"] },
      { day: "Monday", slotCodes: ["P3"] },
      { day: "Monday", slotCodes: ["P4"] },
      { day: "Monday", slotCodes: ["P5"] },
      { day: "Tuesday", slotCodes: ["P1"] },
      { day: "Tuesday", slotCodes: ["P2"] },
      { day: "Tuesday", slotCodes: ["P3"] },
      { day: "Tuesday", slotCodes: ["P4"] },
      { day: "Tuesday", slotCodes: ["P5"] },
      { day: "Wednesday", slotCodes: ["P1"] },
      { day: "Wednesday", slotCodes: ["P2"] },
      { day: "Wednesday", slotCodes: ["P3"] },
      { day: "Wednesday", slotCodes: ["P4"] },
      { day: "Wednesday", slotCodes: ["P5"] },
      { day: "Thursday", slotCodes: ["P1"] },
      { day: "Thursday", slotCodes: ["P2"] },
      { day: "Thursday", slotCodes: ["P3"] },
      { day: "Thursday", slotCodes: ["P4"] },
      { day: "Thursday", slotCodes: ["P5"] },
      { day: "Friday", slotCodes: ["P1"] },
      { day: "Friday", slotCodes: ["P2"] },
      { day: "Friday", slotCodes: ["P4"] },
      { day: "Friday", slotCodes: ["P5"] },
    ],
  },
  aLevel: {
    lessonsPerSubject: 2,
