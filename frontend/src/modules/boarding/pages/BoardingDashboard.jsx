    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1rem", marginTop: "1.25rem" }}>
        {[
          ...
          >
            <div style={{ color: "#4ade80", fontSize: "0.75rem", fontWeight: 900, letterSpacing: "0.14em", textTransform: "uppercase" }}>Module</div>
            <h3 style={{ margin: "0.5rem 0 0", fontSize: "1.05rem" }}>{card.title}</h3>
            <p style={{ margin: "0.65rem 0 0", color: "rgba(241,245,249,0.72)", lineHeight: 1.55 }}>{card.desc}</p>
          </button>
        ))}
      </div>
    </BoardingAdminShell>
