...
const COMMENT_BANKS = {
  incompleteLoad: [
    ...
    "The current AOI 1 picture is incomplete. Outstanding subject scores require follow-up.",
    "A complete progress judgment awaits the remaining AOI 1 subject scores.",
    "Some subject results are still outstanding and should be submitted for a complete record.",
    "The available scores give only a partial picture of progress. Please follow up on the outstanding subjects.",
    "Further assessment information is required before the learner's progress can be judged fully.",
  ],
  low: [
    ...
    "The learner can improve through regular revision and careful correction of classwork.",
    "More attention to foundational skills will help the learner make stronger progress.",
    "The current results call for focused practice and consistent academic support.",
    "The learner should seek guidance in difficult areas and practise more frequently.",
    "A stronger study routine is needed to build confidence and improve understanding.",
    "With closer follow-up and steady effort, the learner can make meaningful improvement.",
    "The learner is encouraged to participate actively and revise each subject consistently.",
  ],
  mid: [
    ...
    "A sound AOI 1 performance. Regular revision should help the learner advance.",
    "The learner has made encouraging progress and should now aim for greater accuracy.",
    "A positive start has been made. Consistent preparation will support further growth.",
    "The learner shows good understanding and can improve further through focused practice.",
    "Progress is evident across the assessed work. Continued effort is encouraged.",
    "The learner is building a solid foundation and should participate with confidence.",
    "Encouraging results have been recorded. Careful revision can raise the overall standard.",
    "A satisfactory performance. The learner should sustain effort in every subject.",
    "The learner is on the right path and should continue working with purpose.",
    "Good understanding is emerging. Attention to challenging areas will strengthen performance.",
    "The learner has responded well to AOI 1 and should maintain disciplined study habits.",
    "A balanced performance has been achieved. Continued practice should bring stronger results.",
    "The learner demonstrates potential and should remain consistent in class and revision.",
    "Positive progress is visible. The next step is to improve accuracy and confidence.",
    "The current performance is encouraging. Regular follow-up will support further improvement.",
    "A commendable effort in AOI 1. The learner should build on this foundation.",
    "The learner has performed reasonably well and should continue aiming higher.",
    "There is clear academic promise. Sustained focus will help produce stronger outcomes.",
  ],
  high: [
    ...
    "An impressive AOI 1 performance. The learner should maintain this purposeful approach.",
    "The learner has demonstrated strong understanding across the assessed work.",
    "Excellent progress is evident. Continued curiosity and discipline will sustain it.",
    "A highly encouraging performance. The learner should keep challenging themselves.",
    "The learner is working at a strong level and should preserve these effective study habits.",
    "Commendable achievement has been recorded. Consistent effort will support continued excellence.",
    "The learner shows excellent academic potential and should continue setting ambitious goals.",
    "A confident and capable performance. The learner should sustain focus across all subjects.",
  ],
  missed: [
  ...
  missedMultiple: [
    ...
    "The learner missed more than one AOI 1 assessment and should complete the outstanding work.",
    "Multiple assessments were missed. Timely follow-up is needed to restore a complete progress record.",
    "Several subject scores are unavailable because the learner missed the assessments.",
  ],
  pending: [
